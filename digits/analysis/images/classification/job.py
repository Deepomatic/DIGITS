...
from ..job import ImageAnalysisJob
from digits.webapp import app, scheduler
# NOTE: Increment this everytime the pickled object changes
PICKLE_VERSION = 1

@subclass
class ImageClassificationAnalysisJob(ImageAnalysisJob):
    """
    ...
    def __init__(self, modeljob_id, model_epoch=None, **kwargs):
        ...
        super(ImageClassificationAnalysisJob, self).__init__(**kwargs)
        self.pickver_job_analysis_image_classification = PICKLE_VERSION
    ...
    @override
    def job_type(self):
        return 'Image Classification Model Analysis'
